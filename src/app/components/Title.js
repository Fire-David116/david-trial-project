...
const TitleDiv = () => {
    return (
        <div class="h-[2000px] md:h-[995px] w-[95%] md:w-auto">
            <div className="flex grid grid-cols-2 gap-x-6 mt-10 sm:mt-16 bg-black">
                <div class="w-full col-span-2 grid-rows-2 sm:col-span-1 relative">
                    <div class="flex bg-custom-color rounded-[32px] w-[125%] md:w-[96%] h-[63%] md:h-[65%] ml-[-70px] mr-[8px] md:ml-0">
                        <div class="w-3/4">
                        ...
                        <div class="w-2/4">
                            <Image
                                src={bigcoin}
                                alt="Arrow"
                                className="w-[150px] h-auto md:w-[250px] md:h-auto mt-8 md:mt-6 overflow-x-hidden"
                                priority
                            />
                        </div>
                    ...
                    <div className="h-[40%] flex overflow-x-hidden ml-[-70px] md:ml-[0px] w-[123%] md:w-[95%] mr-[30px] ">
                ...
                <div className="w-full h-full col-span-2 sm:col-span-1 relative ml-[-70px] md:ml-[0px] md:col-span-1 w-[95%]">
                    <div className="flex items-center justify-between mb-[32px] mt-[32px] md:mt-[-20px] w-[123%] md:w-[97%]">
                    ...
                    <div className="w-[133%] md:w-[100%] ml-[-15px] md:ml-[0px]">
                        <ChartG />
                    </div>
                </div>
                ...
                <div className="w-[100%] h-full col-span-2 sm:col-span-1 ml-[-32px]">
                    <h2 className="w-full inline-block font-bold capitalize text-3xl md:text-[32px] text-white mb-[32px] mt-[16px] md:mt-[40px] ml-[-32px] md:ml-[32px]">
                        Recent Activity
                    </h2>
                    <div className="ml-[-29px] md:ml-[32px]">
                        <Activity />
                    </div>
                </div>
            </div>
